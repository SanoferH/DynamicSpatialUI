...
IL_0051:
	{
		...
		L_25 = VirtualFuncInvoker1< FieldInfoU5BU5D_t50D47CBECF1AEB152F555803E3329D9E34DBF8D8*, int32_t >::Invoke(85 /* System.Reflection.FieldInfo[] System.Type::GetFields(System.Reflection.BindingFlags) */, L_23, L_24);
		V_2 = L_25;
		V_5 = 0;
		goto IL_0095;
	}
...
IL_0013:
	{
		...
		NullCheck(L_5);
		Type_t* L_6;
		L_6 = VirtualFuncInvoker0< Type_t* >::Invoke(111 /* System.Type System.Type::get_BaseType() */, L_5);
		V_0 = L_6;
		Type_t* L_7 = V_0;
		if (!L_7)
		{
...
IL_004b:
	{
		...
		L_22 = VirtualFuncInvoker0< TypeU5BU5D_t97234E1129B564EB38B8D85CAC2AD8B5B9522FFB* >::Invoke(115 /* System.Type[] System.Type::GetInterfaces() */, L_21);
		V_0 = L_22;
		V_1 = 0;
		goto IL_0073;
	}
			...
			{// begin catch(System.Reflection.AmbiguousMatchException)
				{
					...
					L_21 = VirtualFuncInvoker1< MethodInfoU5BU5D_tDF3670604A0AECF814A0B0BA09B91FBF0D6A3265*, int32_t >::Invoke(98 /* System.Reflection.MethodInfo[] System.Type::GetMethods(System.Reflection.BindingFlags) */, L_20, ((int32_t)56));
					V_5 = L_21;
					V_6 = 0;
					goto IL_01bb_1;
				}
...
IL_008a:
	{
		...
		*((int32_t*)L_27) = (int32_t)((int32_t)il2cpp_codegen_add(L_29, 1));
		...
		NullCheck(L_30);
		Type_t* L_31;
		L_31 = VirtualFuncInvoker0< Type_t* >::Invoke(111 /* System.Type System.Type::get_BaseType() */, L_30);
		V_0 = L_31;
	}
...
IL_001d:
	...
	}
	{
		...
		L_10 = VirtualFuncInvoker0< TypeU5BU5D_t97234E1129B564EB38B8D85CAC2AD8B5B9522FFB* >::Invoke(115 /* System.Type[] System.Type::GetInterfaces() */, L_9);
		Type_t* L_11 = ___baseType1;
		bool L_12;
...
IL_0067:
	{
		...
		L_29 = VirtualFuncInvoker0< TypeU5BU5D_t97234E1129B564EB38B8D85CAC2AD8B5B9522FFB* >::Invoke(115 /* System.Type[] System.Type::GetInterfaces() */, L_28);
		V_4 = L_29;
		V_5 = 0;
		goto IL_0091;
	}
...
IL_00ab:
	{
		...
		NullCheck(L_43);
		Type_t* L_44;
		L_44 = VirtualFuncInvoker0< Type_t* >::Invoke(111 /* System.Type System.Type::get_BaseType() */, L_43);
		V_2 = L_44;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TypeExtensions__cctor_m012C51FA1819E981B95E2771DAD0619CB48E4FCE (const RuntimeMethod* method) 
{
	...
	HashSet_1_tAE2F12E55878645F5BE7C4D5603228A6FAB429C7* V_1 = NULL;
	{
		...
		NullCheck(L_212);
		Type_t* L_213;
		L_213 = VirtualFuncInvoker0< Type_t* >::Invoke(124 /* System.Type System.Type::MakePointerType() */, L_212);
...
IL_001b:
	...
	}
	{
		...
		NullCheck(L_3);
		Type_t* L_4;
		L_4 = VirtualFuncInvoker0< Type_t* >::Invoke(111 /* System.Type System.Type::get_BaseType() */, L_3);
		if (L_4)
		{
			goto IL_0039;
		}
